...
const icons = {
  ...
  'check': [<path key="1" className="path01" d="M24.7,0.4c-7.3,0-14.1,3.9-17.7,10.2c-0.3,0.5-0.3,1-0.2,1.5c0.1,0.5,0.5,0.9,0.9,1.2c1,0.6,2.2,0.2,2.7-0.7
  c2.9-5.1,8.4-8.2,14.3-8.2c9.1,0,16.5,7.4,16.5,16.5c0,9.1-7.4,16.5-16.5,16.5c-5.9,0-11.3-3.2-14.3-8.2c-0.6-1-1.8-1.3-2.7-0.7
  c-1,0.6-1.3,1.8-0.7,2.7c3.7,6.3,10.4,10.2,17.7,10.2c0,0,0,0,0,0c5.5,0,10.6-2.1,14.5-6c3.9-3.9,6-9,6-14.5
  C45.1,9.6,36,0.4,24.7,0.4z"/>,
  <path key="2" className="path02" d="M32,19.4l-5.6-5.6c-0.8-0.8-2-0.8-2.8,0c-0.8,0.8-0.8,2,0,2.8l2.2,2.2h-3.1c0,0,0,0,0,0H2.4c-1.1,0-2,0.9-2,2s0.9,2,2,2
  h20.3c0,0,0,0,0,0h3.1l-2.2,2.2c-0.8,0.8-0.8,2,0,2.8c0.8,0.8,2,0.8,2.8,0l5.6-5.6C32.7,21.5,32.7,20.2,32,19.4z"/>],

  'eye': [<path key="1" className="path01" d="M31.7,40.4c-17.2,0-30.7-18.2-31.3-19c-0.5-0.7-0.5-1.7,0-2.5C1,18.2,14.5,0,31.7,0S62.4,18.2,63,19c0.5,0.7,0.5,1.7,0,2.5
  C62.4,22.2,48.9,40.4,31.7,40.4z M4.8,20.2c3.3,3.9,14.2,16,26.9,16c12.7,0,23.7-12.1,26.9-16c-3.3-3.9-14.2-16-26.9-16
  C19,4.2,8,16.2,4.8,20.2z"/>,
  <path key="2" className="path02" d="M31.7,32.7c-6.9,0-12.5-5.6-12.5-12.5S24.8,7.7,31.7,7.7s12.5,5.6,12.5,12.5S38.6,32.7,31.7,32.7z M31.7,11.8
