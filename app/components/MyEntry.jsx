...
export default class MyEntry extends React.Component {
  ...
  componentDidUpdate(prevProps){
    if(this.mobileAndTabletCheck() && this.props.value === prevProps.value) {
      // $.mobile.zoom.disable();
      this.passInput.blur();
    } else {
      this.passInput.focus();
            ...
            <div className="input_box">
              ...
              <div className="input_case">
                <div className="input_text">
                  <input className="main_input" type={this.props.hide_pass ? 'password':'text'} onMouseDown={ (e) => {console.log("pepe"); e.target.focus();} } spellCheck="false" autoComplete="off" placeholder="introduce una contraseña" value={this.props.value} onChange={this.props.handleInputChange} ref={(input) => { this.passInput = input; }} />
