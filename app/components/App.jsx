  ...
  render(){
    ...
    return (
      <div id="container">
        ...
        <ModalEnd number_of_tries={this.props.password.number_of_tries} objectives_accomplished={this.props.password.objectives_accomplished} tracking={this.props.tracking} show={this.state.showModalEnd} handleClose={this.handleCloseModal}/>
