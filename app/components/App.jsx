  ...
  render(){
    ...
    return (
      <div id="container">
        ...
        <ModalEnd dispatch={this.props.dispatch} number_of_tries={this.props.password.number_of_tries} tracking={this.props.tracking} show={this.state.showModalEnd} handleClose={this.handleCloseModal}/>
